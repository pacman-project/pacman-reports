...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.5\textwidth,height=0.2\textheight]{imgs/rel2.pdf}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.4\textheight]{imgs/rel3.pdf}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.4\textheight]{imgs/rel4.pdf}
\end{center}
...
\item[Attachment] (following pages)
\end{description}
\includepdf[pages=-]{./attachedPapers/antonelliGabicciniMarcelloni-techReport.pdf}
