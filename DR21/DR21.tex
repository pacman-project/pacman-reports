...
\begin{description}
	...
	\item[Info] Submitted to the 2015 IEEE Computer Vision and Pattern Recognition. \comment{[CR] SHOULDN'T BE ICRA? IF SO, SHOULDN'T YOU HAVE THE DECISION ALREADY?}
...
\subsection{Learning Part-Based 3D Compositional Object Representations} \label{ann:cvpr} 
\begin{description}
