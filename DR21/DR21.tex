...
SVM classifier. The details of the developed method are included in Annex~\ref{ann:techReportKiechle}. The results of the analysis showed that our 
...
outperformed state-of-the-art methods \citep{vfh}, which achieved poor results 
...
difference from other works \citep{rel2,comp2} introducing hierarchical 
...
outperforming state-of-the-art methods \citep{vfh}. 

Moreover, our proposed method performed better at decomposing an object into 
parts, compared with \citep{rel7}, where the notion of object convexity and 
...
\citep{part2,part3,part1}, parts are manually labeled in the training examples, 
