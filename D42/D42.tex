...
\headerauthor{H. Marino, M. Bonilla, D. Resasco, C. Rosales, M. Gabiccini}
...
(INPUT FROM CLAUDIO) In Sec.~\ref{sec:GraspingUncertainty}, ...
...
\bibliography{../shared_bibliography/abbreviations,./bibliography/D42}
