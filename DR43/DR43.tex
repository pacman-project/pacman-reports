...
\input{./inputFiles/CompositionalGrasping.tex}
...
\begin{description}
    ...
    \item[Attachment] (following pages until next annex)
\end{description}
\includepdf[pages=-]{./attachedPapers/zito-et-al-ar-active-grasp.pdf}
...
method.
    ...
    \item[Attachment] (following pages until next annex)
\end{description}
\includepdf[pages=-]{./attachedPapers/graspparts3d-ijrr2016.pdf}
