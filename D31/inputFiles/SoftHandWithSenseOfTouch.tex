...
=======
\noindent where its the length is 
\begin{equation*}
...
\end{array} \right\rbrace = \; 334  \;\text{byte}
\end{equation*}

\noindent The sent of this package is regulated by an interrupt every 50Hz via Serial bus.  
\end{enumerate} 
