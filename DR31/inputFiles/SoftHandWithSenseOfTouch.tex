...
To match the joint angles values an simple root mean squares was implemented, the software returns $n$ different minimization numbers $m_n$ and trivially the object in database nearest to the current one has the smallest $m_n$ number. 
