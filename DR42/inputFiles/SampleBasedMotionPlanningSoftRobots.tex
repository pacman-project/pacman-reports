...
More details on this new approach and on the currently achieved results can be found in Sec.~\ref{ann:softPlanning}. % available at this~\href{./attachedPapers/SampleBasedMotionPlanningSoftRobots.pdf}{link}. 