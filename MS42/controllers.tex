%!TEX root = MS42.tex
\section{Implemented Controllers}\nocite{siciliano09}\nocite{bicchi13}
Due to the limited number of control strategies provided by the manufacturer for the KUKA LWR IV robot, a new set of ROS-enabled controllers has been developed in \textit{C++} language\footnote{Source code available at \url{https://github.com/enricocorvaglia/kuka-lwr}}, following some interesting paradigms available in the robotics literature.
...
\subsection{Inverse Kinematics-based Control}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{plots/invkin}
...
\end{equation}
\subsubsection{Hierarchical Inverse Dynamics}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{plots/invdyn}
...
\end{figure}
\subsubsection{Minimum Effort Control}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/minimumeffort_X}
		\subcaption{X-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/minimumeffort_Y}
		\subcaption{Y-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/minimumeffort_Z}
		\subcaption{Z-Axis}
	\end{subfigure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/backstepping_X}
		\subcaption{X-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/backstepping_Y}
		\subcaption{Y-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/backstepping_Z}
		\subcaption{Z-Axis}
	\end{subfigure}
	\caption{Axis-specific end-effector trajectories tracking a 8 figure using Backstepping Control.}
\end{figure}

\subsection{Dynamic Sliding PID Control}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/slidingmode_j1}
		\subcaption{Joint 1}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{plots/slidingmode_j3}
		\subcaption{Joint 3}
	\end{subfigure}
