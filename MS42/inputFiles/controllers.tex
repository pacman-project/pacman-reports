...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{invdyn}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{minimumeffort_X}
		\subcaption{X-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{minimumeffort_Y}
		\subcaption{Y-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{minimumeffort_Z}
		\subcaption{Z-Axis}
	\end{subfigure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{backstepping_X}
		\subcaption{X-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{backstepping_Y}
		\subcaption{Y-Axis}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{backstepping_Z}
		\subcaption{Z-Axis}
	\end{subfigure}
...
\begin{figure}[H]
	\centering
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{slidingmode_j1}
		\subcaption{Joint 1}
	\end{subfigure}
	\\
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[height=0.275\textheight]{slidingmode_j3}
		\subcaption{Joint 3}
	\end{subfigure}
